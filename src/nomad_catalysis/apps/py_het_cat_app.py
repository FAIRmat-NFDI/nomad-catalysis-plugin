...
heterogeneous_catalysis_app = App(
    ...
    columns= [
        ...
        Column(quantity= "results.properties.catalytic.reaction.name", label="Reaction name", selected = True),
        Column(quantity= "results.properties.catalytic.catalyst.catalyst_type", selected = True),
        Column(quantity= "results.properties.catalytic.catalyst.preparation_method",
               label="Preparation", selected = True),
        Column(quantity= "results.properties.catalytic.catalyst.surface_area",
        ...
        Column(quantity= "results.properties.catalytic.reaction.reactants.name", label="Reactants"),
        Column(quantity= "results.properties.catalytic.reaction.products.name", label="Products"),
        Column(quantity= "results.properties.catalytic.reaction.reaction.type", label="Reaction type"),
        ...
        Column(quantity= "data.datetime#nomad_catalysis.schema_packages.catalysis.CatalystSample", label= "Sample preparation time"),
        Column(quantity= "data.datetime#nomad_catalysis.schema_packages.catalysis.CatalyticReaction", label= "Measurement time"),
    ],
        ...
        items= [
            ...
            Menu(
                ...
                items= [
                    ...
                    MenuItemTerms(search_quantity= "results.material.chemical_formula_hill", width= 6, options= 0),
                    MenuItemTerms(search_quantity= "results.material.chemical_formula_iupac", width= 6, options= 0),
                    MenuItemTerms(search_quantity= "results.material.chemical_formula_reduced", width= 6, options= 0),
                    MenuItemTerms(search_quantity= "results.material.chemical_formula_anonymous", width= 6, options= 0),
                    MenuItemHistogram(x= {"search_quantity": "results.material.n_elements"}),
                ],
            ),
            Menu(
                ...
                size= "md",
                items= [
                    MenuItemTerms(search_quantity= "results.properties.catalytic.catalyst.catalyst_type"),
                    MenuItemTerms(search_quantity= "results.properties.catalytic.catalyst.support"),
                    MenuItemTerms(search_quantity= "results.properties.catalytic.catalyst.preparation_method"),
                    MenuItemTerms(search_quantity= "results.properties.catalytic.catalyst.catalyst_name"),
                    MenuItemTerms(search_quantity= "data.form#nomad_catalysis.schema_packages.catalysis.CatalystSample"),
                    MenuItemTerms(search_quantity= "results.properties.catalytic.catalyst.characterization_methods"),
                    MenuItemHistogram(x= {"search_quantity": "results.properties.catalytic.catalyst.surface_area", "unit": "m^2/g"}, autorange= False),
                ],
            ),
            Menu(
                title= "Reactions",
                ...
                indentation= 1,
                items=[
                    MenuItemTerms(search_quantity= "results.properties.catalytic.reaction.type"),
                    MenuItemTerms(search_quantity= "results.properties.catalytic.reaction.name"),
                ],
            ),
            Menu(
            title= "Reactants",
            ...
            size= "md",
            items=[
                MenuItemTerms(search_quantity= "results.properties.catalytic.reaction.reactants.name"),
                MenuItemHistogram(x= {"search_quantity": "results.properties.catalytic.reaction.reactants.conversion"}),
                MenuItemHistogram(x= {"search_quantity": "results.properties.catalytic.reaction.reactants.mole_fraction_in"}),
                MenuItemHistogram(x= {"search_quantity": "results.properties.catalytic.reaction.reactants.mole_fraction_out"}),
            ],
            ),
            Menu(
            title= "Products",
            ...
            size= "md",
            items=[
                MenuItemTerms(search_quantity= "results.properties.catalytic.reaction.products.name"),
                MenuItemHistogram(x= {"search_quantity": "results.properties.catalytic.reaction.products.selectivity"}),
                MenuItemHistogram(x= {"search_quantity": "results.properties.catalytic.reaction.products.mole_fraction_out"}),
            ],
            ),
            Menu(
            ...
            size= "md",
            items=[
                MenuItemHistogram(x= {"search_quantity": "results.properties.catalytic.reaction.reaction_conditions.temperature"}),
                MenuItemHistogram(x= {"search_quantity": "results.properties.catalytic.reaction.reaction_conditions.pressure", "unit": "bar"}),
                MenuItemHistogram(x= {"search_quantity": "results.properties.catalytic.reaction.reaction_conditions.weight_hourly_space_velocity", "unit": "ml/(g*hr)"}),
            ],
            ),
            Menu(
            ...
            Menu(
                ...
                items= [
                    ...
                    MenuItemHistogram(x= {"search_quantity": 
    ...
    dashboard=Dashboard(
        widgets= [
            ...
            WidgetScatterPlot(
                ...
                x= Axis(search_quantity= "results.properties.catalytic.reaction.reactants[*].mole_fraction_in", 
                        title= 'Feed composition'),
                y= Axis(search_quantity= "results.properties.catalytic.reaction.reaction_conditions.temperature"),
            ...
            WidgetScatterPlot(
                ...
                x= Axis(search_quantity= "results.properties.catalytic.reaction.reaction_conditions.temperature"),
                y= Axis(search_quantity= "results.properties.catalytic.reaction.reactants[*].conversion", title= 'Conversion (%)'),
                color= "results.properties.catalytic.reaction.reactants[*].name",
                size= 1000
                )
        ]
